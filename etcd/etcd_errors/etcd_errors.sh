...
do 
    ...
    then
        ...
        echo -e "ETCD DATABASE SPACE HAS NOT EXCEEDED \n"
        break
    fi
done
...
do 
    ...
    then
        ...
        echo -e "ETCD HAS NO LEADERSHIP CHANGES OR FAILURES \n"
        break
    fi
done